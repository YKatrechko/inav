...
rem:  -- 32 bit version
"%ProgramFiles%\STMicroelectronics\Software\Flash Loader Demonstrator\STMFlashLoader.exe"  -c --pn %commportnum% --br 230400  -i STM32_Med-density_128K -e --all -d --fn %str% --a 0x8000000 -r --a 0x8000000 
